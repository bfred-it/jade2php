...
(function() {
  ...
  Compiler.prototype = {
    ...
    visitLoop: function(loopNode) {
      ...
      loopType = m[1];
      conditions = m[2];
      this.buf.push("<?php " + loopType + " (" + parseCondition(conditions) + ") : ?>");
      if (loopNode.block) {
    ...
    visitIf: function(ifNode) {
      ...
      this.buf.push("<?php if (" + parseCondition(ifNode.condition) + ") : ?>");
      if (ifNode.block) {
      ...
      if (!ifNode.nextElses) {
        ...
        for (k = 0, len1 = ref.length; k < len1; k++) {
          ...
          if (alternative.val === "else") {
            ...
            condition = m[1];
            this.buf.push("<?php elseif (" + parseCondition(condition) + ") : ?>");
            this.visit(alternative.block);
          }
        }
        return this.buf.push("<?php endif ?>");
